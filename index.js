//#region node_modules/@webcomponents/scoped-custom-element-registry/scoped-custom-element-registry.min.js
(function() {
	function k(a) {
		var b = 0;
		return function() {
	...
	I.prototype.define = function(a, b) {
		...
		if (c = this.i.get(a)) for (this.i.delete(a), c = q(c), e = c.next(); !e.done; e = c.next()) e = e.value, F.delete(e), J(e, d, !0);
		c = this.j.get(a);
	...
	function ia(a) {
		...
		b.prototype.connectedCallback = function(d) {
			...
			N(this);
			(c = E.get(this)) ? c.connectedCallback && c.connectedCallback.apply(this, e) : L(F.get(this), this, a, !0);
		};
		b.prototype.disconnectedCallback = function(d) {
			for (var e = [], c = 0; c < arguments.length; ++c) e[c] = arguments[c];
			(c = E.get(this)) ? c.disconnectedCallback && c.disconnectedCallback.apply(this, e) : L(F.get(this), this, a, !1);
		};
	...
	if (window.ElementInternals && window.ElementInternals.prototype.setFormValue) {
		var U = /* @__PURE__ */ new WeakMap(), V = HTMLElement.prototype.attachInternals, methods = [
			"setFormValue",
			"setValidity",
			"checkValidity",
			"reportValidity"
		...
		methods.forEach(function(a) {
			...
			b[a] = function(e) {
				...
				f = U.get(this);
				if (!0 === E.get(f).formAssociated) return null == d ? void 0 : d.call.apply(d, [this].concat(r(c)));
...
//#endregion
//#region index.js
var MyGreeting = class extends HTMLElement {};
